...
function matchWithPrefixString = function(req, res)
{
    ;
};
...
var HttpRouter = exports = module.exports = function()
{
    this.routes = [];
};

HttpRouter.prototype.for = function(pattern)
{
    var route = new HttpRoute(pattern);
    this.routes.push(route);
    return route;
};

HttpRouter.prototype.find = function(req, res)
{
...
HttpRouter.prototype.route = function(req, res)
{
    ...
    req.url = {};
    req.url.args  = [];
    req.url.path  = requestUrl.pathname;
    req.url.query = requestUrl.query;

    var routeFound = false
      , numberOfRoutes = this.routes.length;
